    ...
    foreach ($_POST['checkBoxArray'] as $postValueId) {
        ...
        switch ($bulk_options) {
            ...
            case 'clone':
                ...
                $query = "INSERT INTO posts(post_category_id,post_user, post_title, post_author, post_date,post_image,post_content,post_tags,post_status) ";
                $query .= "VALUES({$post_category_id},'{$post_user}','{$post_title}','{$post_author}',now(),'{$post_image}','{$post_content}','{$post_tags}', '{$post_status}') ";
